    ...
    <>
        <div className="w-ful h-16 flex items-center px-12 bg-red-600">
           ...
           <div className='w-full flex items-center p-12 '>
            ...
            hover:border-2 hover:border-white hover:text-green-400 hover:shadow-md rounded-lg font-bold text-white py-2 px-2">Add Users</Link>
            <Link to={"/Get"} className="hover:bg-black
            hover:border-2 hover:border-white hover:text-yellow-400 hover:shadow-md rounded-lg font-bold text-white py-2 px-2">All Users</Link>
